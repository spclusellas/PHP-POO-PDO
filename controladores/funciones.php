...
// En esta parte declaro que si el usuario selecciono la opcion de recordar,lo que me llegue por $_POST en las posiciones de email y contraseña va a quedar guardado en $_COOKIE del navegador con los nombres correspondientes.
...
function recordarUsuario($input){
